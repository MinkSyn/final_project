...
def load_model(last_layer='all_KNN'):
	...
	if last_layer == 'all_KNN':
		...
		checkpoint_not_mask = torch.load(ROOT+'/models/parameter/classify/model_not_mask_100.pt', map_location='cpu')
		net_not_mask.load_state_dict(checkpoint_not_mask['model_state_dict'])

		checkpoint_mask = torch.load(ROOT+'/models/parameter/classify/model_mask_100.pt', map_location='cpu')
